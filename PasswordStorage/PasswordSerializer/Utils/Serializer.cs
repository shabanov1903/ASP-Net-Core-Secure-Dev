...
namespace PasswordSerializer.Utils
{
    // Save data in C:\Users\shaba\AppData\Local
    public class Serializer
    {
        ...
        static byte[] additionalEntropy = { 0, 1, 2, 3, 4 };

        public void Serialize(List<ConnectionString> connections)
        {
            try
            {
        ...
        public List<ConnectionString> Deserialize()
        {
            try
            {
                XmlSerializer xmlSerializer = new XmlSerializer(typeof(List<ConnectionString>));
